...
export const usePermissionsStore = defineStore('permissions', {
  ...
  getters: {
    ...
    canViewBookings() {
      return this.permissionService?.hasPermission(PERMISSIONS.VIEW_BOOKINGS) || false
    },
    canCreateBookings() {
      return this.permissionService?.hasPermission(PERMISSIONS.CREATE_BOOKINGS) || false
    },
    canEditBookings() {
      return this.permissionService?.hasPermission(PERMISSIONS.EDIT_BOOKINGS) || false
    },
    canDeleteBookings() {
      return this.permissionService?.hasPermission(PERMISSIONS.DELETE_BOOKINGS) || false
    },
    canManageBookingStatus() {
      return this.permissionService?.hasPermission(PERMISSIONS.MANAGE_BOOKING_STATUS) || false
    },
    
    // Customers permissions
    canViewCustomers() {
      return this.permissionService?.hasPermission(PERMISSIONS.VIEW_CUSTOMERS) || false
    },
    canCreateCustomers() {
      return this.permissionService?.hasPermission(PERMISSIONS.CREATE_CUSTOMERS) || false
    },
    canEditCustomers() {
      return this.permissionService?.hasPermission(PERMISSIONS.EDIT_CUSTOMERS) || false
    },
    canDeleteCustomers() {
      return this.permissionService?.hasPermission(PERMISSIONS.DELETE_CUSTOMERS) || false
    },
    canManageCustomerVehicles() {
      return this.permissionService?.hasPermission(PERMISSIONS.MANAGE_CUSTOMER_VEHICLES) || false
    },
    
    // Services permissions
    canViewServices() {
      return this.permissionService?.hasPermission(PERMISSIONS.VIEW_SERVICES) || false
    },
    canCreateServices() {
      return this.permissionService?.hasPermission(PERMISSIONS.CREATE_SERVICES) || false
    },
    canEditServices() {
      return this.permissionService?.hasPermission(PERMISSIONS.EDIT_SERVICES) || false
    },
    canDeleteServices() {
      return this.permissionService?.hasPermission(PERMISSIONS.DELETE_SERVICES) || false
    },
