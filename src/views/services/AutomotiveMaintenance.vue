<template>
  <div class="automotive-maintenance">
      ...
      <div class="header-content">
        <div class="header-info">
          ...
          <div class="title-section">
            <h1>Automotive Maintenance Services</h1>
            <p class="category-description">Preventive maintenance services to keep vehicles running smoothly</p>
          </div>
        </div>
    ...
    <div class="content-wrapper">
      ...
      <div v-if="filteredServices.length === 0" class="empty-state">
        ...
        <h3>No Automotive Maintenance Services</h3>
        <p>Start by adding your first automotive maintenance service</p>
        <button @click="showAddServiceModal = true" class="btn-primary">
          <i class="fas fa-plus"></i>
    ...
    return {
      ...
      services: [
        ...
        },
        {
          ...
          description: 'Professional tire rotation and balancing service for even wear',
          duration: 45,
          price: 80.00,
          requiresVehicle: true,
          isActive: true,
        ...
        },
        {
          ...
          description: 'Battery test and electrical system inspection',
          duration: 25,
          price: 25.00,
          requiresVehicle: true,
          isActive: true,
        ...
        {
          id: 'am005',
          name: 'Fluid Top-Off Service',
          description: 'Check and top-off all essential vehicle fluids',
          duration: 20,
          price: 30.00,
          requiresVehicle: true,
          isActive: true,
        ...
        },
        {
          ...
          description: 'Engine and cabin air filter inspection and replacement',
          duration: 20,
          price: 40.00,
          requiresVehicle: true,
          isActive: false,
